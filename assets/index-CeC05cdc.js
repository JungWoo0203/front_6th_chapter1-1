...
<div class="p-3">
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    `}const U=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-EepaDAeu.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>{e.start(t)});async function W(){let e=l.getAppPath(window.location.pathname);l.handle(e)}U().then(W),l.add(`/`,()=>{L.init()}),l.add(`/product/:id`,async({id:e})=>{await V.show(e)}),l.setNotFound(()=>{document.querySelector(`#root`).innerHTML=H()});