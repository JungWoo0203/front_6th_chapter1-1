...
<div class="p-3">
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    `}const U=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-DK6whEil.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));async function W(){l.handle(window.location.pathname)}U().then(W),l.add(l.BASE_PATH,()=>{L.init()}),l.add(l.BASE_PATH+`/product/:id`,async({id:e})=>{await V.show(e)}),l.setNotFound(()=>{document.querySelector(`#root`).innerHTML=H()});